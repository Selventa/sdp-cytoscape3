...
:: Modified: change directory to where this script lives
pushd "%~dp0"
...
set PWD=%~dp0
set KARAF_OPTS=-Xms128M -Dcom.sun.management.jmxremote -Dcytoscape.home="%PWD:\=\\%" -splash:CytoscapeSplashScreen.png

...
export TOOLS_S3CMD_FILE="${TOOLS_S3CMD_FILE:=$TOOLS_DIR/s3cmd/s3cmd}"

# -- Resources --
export TOOLS_S3CMD_CONFIG_FILE="${TOOLS_S3CMD_CONFIG:=$DIST_RESOURCES_DIR/s3/config}"
...
# -- bash aliases --
alias s3="$TOOLS_S3CMD_FILE -c $TOOLS_S3CMD_CONFIG_FILE"
